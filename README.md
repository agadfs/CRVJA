...
npm run dev
```
This command will start the development server, allowing you to see live updates as you modify the code.<br />
To Move the player, use WASD keys on the keyboard.<br />
# Project Structure
